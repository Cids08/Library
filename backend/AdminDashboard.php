...
<body>
    ...
    <script>
        // Dummy data for recent borrowed books
        const recentBooks = [
            {
            ...
            },
            {
                ...
                borrower: "Lisa Martinez",
                borrowedDate: "2025-05-07",
                dueDate: "2025-05-21",
                status: "active"
            },
            {
                title: "Lord of the Flies",
                borrower: "Kevin Thomas",
                borrowedDate: "2025-05-06",
                dueDate: "2025-05-20",
                status: "active"
            },
            {
                title: "The Alchemist",
                borrower: "Linda Garcia",
                borrowedDate: "2025-05-05",
                dueDate: "2025-05-19",
                status: "returned"
            },
            {
        ...
        // Populate the recent books table
        function populateRecentBooks() {
            const tableBody = document.getElementById('recent-books');
            tableBody.innerHTML = '';
            ...
            recentBooks.forEach(book => {
                ...
                row.innerHTML = `
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-medium text-gray-900 book-title">${book.title}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-500 borrower-name">${book.borrower}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-500 date">${borrowedDate}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-500 date">${dueDate}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div class="flex space-x-2 action-buttons">
                            <button class="action-button view text-indigo-600 hover:text-indigo-900">
                                <i class="fas fa-eye"></i>
                            </button>
                            <button class="action-button edit text-yellow-600 hover:text-yellow-900">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="action-button delete text-red-600 hover:text-red-900">
